...
As a technical writer at Sendbird, a SaaS chat solution provider, I maintained and improved the Chat SDK documentation to support developers integrating chat features across multiple platforms.
