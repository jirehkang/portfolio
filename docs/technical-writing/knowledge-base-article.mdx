...
As a technical writer at Sendbird, a leading B2B chat platform, I created a knowledge base article for the Agents feature in Sendbird's customer support chat product called Desk.
