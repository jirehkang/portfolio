...
As a technical writer at Sendbird, a leading SaaS chat solution provider, I documented a new feature called Polls, which enables users to create and vote in polls directly within chat conversations.
