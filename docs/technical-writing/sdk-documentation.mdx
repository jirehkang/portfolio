...
As a technical writer at Sendbird, a leading SaaS chat platform, I maintained and improved the Chat SDK documentation to support developers integrating chat features across multiple platforms.
