/*! For license information please see main.88d08418.js.LICENSE.txt */
	...
	[792],
	{
		...
		102: (e, t, n) => {
			...
			const g = (e, t) => void 0 !== e && (0, l.ys)(e, t),
				h = (e, t) => e.some((e) => y(e, t));
			function y(e, t) {
				return "link" === e.type
					? g(e.href, t)
					: "category" === e.type && (g(e.href, t) || h(e.items, t));
			}
			function b(e, t) {
				switch (e.type) {
					case "category":
			...
			function x(e) {
				const { activeVersion: t } = (0, i.zK)(e),
					...
					o = (0, i.r7)(e);
				return (0, r.useMemo)(() => s([t, n, o].filter(Boolean)), [t, n, o]);
			}
			function S(e, t) {
				const n = x(t);
				return (0, r.useMemo)(() => {
			...
			function C(e) {
				return e.filter(
					(e) => !("category" === e.type || "link" === e.type) || !!f(e)
				);
			}
		},
		115: (e) => {
		...
		372: (e, t, n) => {
			...
			n.d(t, { A: () => o });
			var r = n(6540);
			const o = n(1934).A.canUseDOM ? r.useLayoutEffect : r.useEffect;
		},
		539: (e, t, n) => {
			"use strict";
			n.d(t, { A: () => u, T: () => s });
			...
			var h = {
				...
				z = function (e) {
					...
					return {
						...
						style: M(h.STYLE, i, r),
						title: M(h.TITLE, { title: s, titleAttributes: u }, r),
					};
				},
				B = [],
				$ = function (e, t) {
		...
		1410: (e, t, n) => {
			...
			function W(e) {
				...
				const n = (0, w.p)().navbar.style,
					...
					{ colorMode: o, setColorMode: a } = (0, M.G)();
				return r
					? null
					: (0, c.jsx)(H, {
							className: t,
			...
			function Y() {
				return (0, c.jsxs)("div", {
					...
					children: [
						(0, c.jsx)(K, {}),
						(0, c.jsx)(W, { className: "margin-right--md" }),
						(0, c.jsx)(Q, {}),
					],
				});
			}
			...
			var ie = n(3535),
				le = n(214),
				se = n(797);
			const ue = "dropdownNavbarItemMobile_S0Fm";
			function ce(e, t) {
				return e.some((e) =>
					(function (e, t) {
						return (
			...
			function He() {
				...
				return (0, c.jsx)(qe, {
					...
					right: (0, c.jsxs)(c.Fragment, {
						children: [
							(0, c.jsx)(Ue, { items: r }),
							(0, c.jsx)(W, { className: $e.colorModeToggle }),
			...
			function We(e) {
				...
				const {
						...
						href: r,
						label: a,
						prependBaseUrlToHref: i,
						className: l,
						...s
					} = t,
					u = (0, X.Ay)(n),
					d = (0, X.Ay)(r, { forcePrependBaseUrl: !0 });
				return (0, c.jsxs)(Z.A, {
					className: (0, o.A)("footer__link-item", l),
					...(r ? { href: i ? d : r } : { to: u }),
					...s,
					children: [a, r && !(0, J.A)(r) && (0, c.jsx)(te.A, {})],
				});
			}
			function Ve(e) {
				let { item: t } = e;
				return t.html
					? (0, c.jsx)("li", {
							className: (0, o.A)("footer__item", t.className),
			...
			function Ke(e) {
				let { column: t } = e;
				return (0, c.jsxs)("div", {
					className: (0, o.A)("col footer__col", t.className),
					children: [
						(0, c.jsx)("div", {
						...
						(0, c.jsx)("ul", {
							...
							children: t.items.map((e, t) => (0, c.jsx)(Ve, { item: e }, t)),
						}),
					],
				});
			}
			function Qe(e) {
				...
				return (0, c.jsx)("div", {
					...
					children: t.map((e, t) => (0, c.jsx)(Ke, { column: e }, t)),
				});
			}
			function Ye() {
				return (0, c.jsx)("span", {
			...
			function Ze(e) {
				...
				return t.html
					? (0, c.jsx)("span", {
							className: (0, o.A)("footer__link-item", t.className),
							dangerouslySetInnerHTML: { __html: t.html },
					  })
					: (0, c.jsx)(We, { item: t });
			}
		...
		2551: (e, t, n) => {
			...
			function $e(e, t, n, r, o, a, i, l, s) {
				(Ie = !1), (Fe = null), De.apply(Be, arguments);
			}
			function Ue(e) {
				var t = e,
					n = e;
					...
					if (!(7 & t)) {
						if (
							...
							if (
								...
								e: {
									for (p = u, m = 0, f = c = s; f; f = Vr(f)) m++;
									for (f = 0, g = p; g; g = Vr(g)) f++;
									for (; 0 < m - f; ) (c = Vr(c)), m--;
									for (; 0 < f - m; ) (p = Vr(p)), f--;
									for (; m--; ) {
			...
			function qo() {
				if (!$o && null !== zo) {
					...
					try {
						...
						throw (null !== zo && (zo = zo.slice(e + 1)), Ve(Je, qo), o);
					} finally {
						(vt = t), ($o = !1);
					}
				}
			...
			var Ho = [],
				...
				Xo = "";
			function Jo(e, t) {
				(Ho[Go++] = Vo), (Ho[Go++] = Wo), (Wo = e), (Vo = t);
			}
			function ea(e, t, n) {
				(Ko[Qo++] = Zo), (Ko[Qo++] = Xo), (Ko[Qo++] = Yo), (Yo = e);
				var r = Zo;
				e = Xo;
				var o = 32 - it(r) - 1;
				(r &= ~(1 << o)), (n += 1);
			...
			function na(e) {
				for (; e === Wo; )
					(Wo = Ho[--Go]), (Ho[Go] = null), (Vo = Ho[--Go]), (Ho[Go] = null);
				for (; e === Yo; )
					(Yo = Ko[--Qo]),
						(Ko[Qo] = null),
						(Xo = Ko[--Qo]),
			...
			function Ya(e, t) {
				switch ((Ao(Ka, t), Ao(Va, e), Ao(Wa, Ga), (e = t.nodeType))) {
					case 9:
					case 11:
			...
			function Vl(e, t, n) {
				...
				switch ((na(t), t.tag)) {
					...
					case 6:
						if (e && null != t.stateNode) Ol(e, t, e.memoizedProps, r);
							...
							if ("string" != typeof r && null === t.stateNode)
								throw Error(a(166));
							if (((n = Qa(Ka.current)), Qa(Wa.current), pa(t))) {
								if (
									((r = t.stateNode),
									(n = t.memoizedProps),
									(r[fo] = t),
					...
					case 10:
						return Ta(t.type._context), Wl(t), null;
					case 19:
						if ((Co(ei), null === (i = t.memoizedState))) return Wl(t), null;
			...
			function gu() {
				(0 !== Os && 3 !== Os && 2 !== Os) || (Os = 4),
					null === js || (!(268435455 & Is) && !(268435455 & Fs)) || lu(js, Ns);
			}
			function hu(e, t) {
				var n = Ts;
				Ts |= 2;
			...
			function wu(e) {
				...
				do {
					...
					} else if (null !== (n = Vl(n, t, Rs))) return void (Ps = n);
			...
			function xu() {
				if (null !== Ks) {
					var e = wt(Qs),
						...
						n = vt;
					try {
						if (((As.transition = null), (vt = 16 > e ? 16 : e), null === Ks))
							var r = !1;
						else {
							if (((e = Ks), (Ks = null), (Qs = 0), 6 & Ts))
								throw Error(a(331));
							var o = Ts;
			...
			Ss = function (e, t, n) {
				...
				else (vl = !1), aa && 1048576 & t.flags && ea(t, Vo, t.index);
		...
		3535: (e, t, n) => {
			...
			function g(e) {
				...
				const d = (0, o.A)(),
					g = (0, r.useRef)(null);
				return (
					f({ collapsibleRef: g, collapsed: n, animation: i }),
					(0, l.jsx)(t, {
						ref: g,
						style: c ? void 0 : m({ collapsed: n, isBrowser: d }),
						onTransitionEnd: (e) => {
							"height" === e.propertyName && (p(g.current, n), s?.(n));
						},
						className: u,
						children: a,
					})
		...
		4054: (e) => {
			...
			e.exports = JSON.parse(
				'{"/portfolio/about-7b8":{"__comp":"7792a21f","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"},"/portfolio/markdown-page-f1a":{"__comp":"1f391b9e","__context":{"plugin":"a7456010"},"content":"393be207"},"/portfolio/projects-3c5":{"__comp":"5e95c892","__context":{"plugin":"aba21aa0"}},"/portfolio/projects-b3b":{"__comp":"a7bd4aaa","__props":"697b45f2"},"/portfolio/projects-ee6":{"__comp":"a94703ab"},"/portfolio/projects/api-reference-357":{"__comp":"17896441","content":"71488238"},"/portfolio/projects/category/writing-projects-3dc":{"__comp":"14eb3368","__props":"cddf4ce6"},"/portfolio/projects/concept-explainer-d86":{"__comp":"17896441","content":"99a9df44"},"/portfolio/projects/method-terminology-4e3":{"__comp":"17896441","content":"cd2ef048"},"/portfolio/projects/sdk-documentation-4da":{"__comp":"17896441","content":"718e43f0"},"/portfolio/projects/user-guide-3d5":{"__comp":"17896441","content":"5e2e8d96"},"/portfolio/projects/ux-writing-fca":{"__comp":"17896441","content":"cc278068"},"/portfolio/-c34":{"__comp":"c4f5d8e4","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"}}'
			);
		},
		4146: (e, t, n) => {
			"use strict";
			...
			const r = {
				...
				themeConfig: {
					...
					footer: {
						style: "dark",
						copyright:
							"Copyright \xa9 2025 Jireh Kang's Writing Portfolio. Built with Docusaurus.",
						links: [],
					},
					prism: {
						theme: {
		...
		5161: (e, t, n) => {
			...
			var r = n(6540),
				...
				l = n(4784),
				s = n(1934);
			const u = [n(7378), n(7264), n(8867), n(2094)];
			var c = n(8912),
				d = n(6347),
				p = n(2831),
				f = n(4848);
				...
				const {
					...
					r = (function () {
						const {
							...
							{ pathname: r } = (0, d.zy)();
						return (
							e + (0, x.Ks)((0, y.Ay)(r), { trailingSlash: n, baseUrl: t })
						);
					})(),
					o = t ? `${n}${t}` : r;
				return (0, f.jsxs)(g.A, {
			...
			function C() {
				...
				return (0, f.jsxs)(f.Fragment, {
					children: [
						...
						(0, f.jsx)(_, {}),
						(0, f.jsx)(E, {}),
						(0, f.jsx)(S.A, { tag: "default", locale: e }),
						(0, f.jsx)(g.A, {
			...
			function M() {
				...
				return (0, f.jsx)(f.Fragment, {
					children:
						!s.A.canUseDOM &&
						(0, f.jsx)(g.A, {
							children: (0, f.jsx)("script", { children: F(e) }),
						}),
				});
			}
			function z() {
			...
			function G() {
				...
				return (0, f.jsx)(D, { location: e, children: H });
			}
			function W() {
				return (0, f.jsx)($.A, {
			...
			const Y = new Set(),
				...
				J = {
					prefetch: (e) => {
						if (!((e) => !X() && !Z.has(e) && !Y.has(e))(e)) return !1;
						Y.add(e);
			...
			if (s.A.canUseDOM) {
				...
				const e = document.getElementById("__docusaurus"),
					t = (0, f.jsx)(a.vd, {
						children: (0, f.jsx)(te, { children: (0, f.jsx)(W, {}) }),
					}),
					n = (e, t) => {
		...
		5302: (e, t, n) => {
			...
			function a(e, t) {
				for (
					var n, r = [], a = 0, l = 0, s = "", u = (t && t.delimiter) || "/";
					null != (n = o.exec(e));
					...
					var d = n[0],
						p = n[1],
						f = n.index;
					if (((s += e.slice(l, f)), (l = f + d.length), p)) s += p[1];
					else {
						var m = e[l],
							g = n[2],
							h = n[3],
		...
		6193: (e, t, n) => {
			...
			var r = n(6540),
				o = n(4784);
			const a = JSON.parse(
					'{"docusaurus-plugin-content-docs":{"default":{"path":"/portfolio/projects","versions":[{"name":"current","label":"Next","isLast":true,"path":"/portfolio/projects","mainDocId":"technical-writing/api-reference","docs":[{"id":"technical-writing/api-reference","path":"/portfolio/projects/api-reference","sidebar":"tutorialSidebar"},{"id":"technical-writing/concept-explainer","path":"/portfolio/projects/concept-explainer","sidebar":"tutorialSidebar"},{"id":"technical-writing/method-terminology","path":"/portfolio/projects/method-terminology","sidebar":"tutorialSidebar"},{"id":"technical-writing/sdk-documentation","path":"/portfolio/projects/sdk-documentation","sidebar":"tutorialSidebar"},{"id":"technical-writing/user-guide","path":"/portfolio/projects/user-guide","sidebar":"tutorialSidebar"},{"id":"technical-writing/ux-writing","path":"/portfolio/projects/ux-writing","sidebar":"tutorialSidebar"},{"id":"/category/writing-projects","path":"/portfolio/projects/category/writing-projects","sidebar":"tutorialSidebar"}],"draftIds":[],"sidebars":{"tutorialSidebar":{"link":{"path":"/portfolio/projects/category/writing-projects","label":"Writing Projects"}}}}],"breadcrumbs":true}}}'
				),
				i = JSON.parse(
		...
		6289: (e, t, n) => {
			...
			function p(e, t) {
				...
				const I = j?.startsWith("#") ?? !1,
					F = !b.target || "_self" === b.target,
					M = !j || !A || !F || (I && "hash" !== x);
				h || (!I && M) || E.collectLink(j), b.id && E.collectAnchor(b.id);
				const z = {};
				return M
					? (0, d.jsx)("a", {
							ref: _,
		...
		8912: (e, t, n) => {
			...
			const i = {
				"14eb3368": [
					() => Promise.all([n.e(869), n.e(969)]).then(n.bind(n, 4561)),
					"@theme/DocCategoryGeneratedIndexPage",
					4561,
				],
				17896441: [
					() =>
						Promise.all([n.e(869), n.e(341), n.e(401)]).then(n.bind(n, 2270)),
					"@theme/DocItem",
					2270,
				],
				"1f391b9e": [
					() =>
						Promise.all([n.e(869), n.e(341), n.e(61)]).then(n.bind(n, 9181)),
					"@theme/MDXPage",
					9181,
				],
				"393be207": [
					() => n.e(134).then(n.bind(n, 4334)),
					"@site/src/pages/markdown-page.md",
					4334,
				],
				"5e2e8d96": [
					() => Promise.all([n.e(869), n.e(159)]).then(n.bind(n, 974)),
					"@site/docs/technical-writing/user-guide.mdx",
					974,
				],
				"5e95c892": [
					() => n.e(647).then(n.bind(n, 8122)),
					"@theme/DocsRoot",
					8122,
				],
				"5e9f5e1a": [
				...
				"697b45f2": [
					() => n.e(182).then(n.t.bind(n, 3277, 19)),
					"@generated/docusaurus-plugin-content-docs/default/p/portfolio-projects-913.json",
					3277,
				],
				71488238: [
					() => Promise.all([n.e(869), n.e(912)]).then(n.bind(n, 7823)),
					"@site/docs/technical-writing/api-reference.mdx",
					7823,
				],
				"718e43f0": [
					() => Promise.all([n.e(869), n.e(75)]).then(n.bind(n, 5994)),
					"@site/docs/technical-writing/sdk-documentation.mdx",
					5994,
				],
				"7792a21f": [
					() => Promise.all([n.e(869), n.e(220)]).then(n.bind(n, 8697)),
					"@site/src/pages/about.js",
					8697,
				],
				"99a9df44": [
					() => Promise.all([n.e(869), n.e(937)]).then(n.bind(n, 93)),
					"@site/docs/technical-writing/concept-explainer.mdx",
					93,
				],
				a7456010: [
				...
				a7bd4aaa: [
					() => n.e(98).then(n.bind(n, 7419)),
					"@theme/DocVersionRoot",
					7419,
				],
				a94703ab: [
					() => Promise.all([n.e(869), n.e(48)]).then(n.bind(n, 1841)),
					"@theme/DocRoot",
					1841,
				],
				aba21aa0: [
				...
				c4f5d8e4: [
					() =>
						Promise.all([n.e(869), n.e(703), n.e(634)]).then(n.bind(n, 6275)),
					"@site/src/pages/index.js",
					6275,
				],
				cc278068: [
					() => Promise.all([n.e(869), n.e(918)]).then(n.bind(n, 730)),
					"@site/docs/technical-writing/ux-writing.mdx",
					730,
				],
				cd2ef048: [
					() => Promise.all([n.e(869), n.e(759)]).then(n.bind(n, 8736)),
					"@site/docs/technical-writing/method-terminology.mdx",
					8736,
				],
				cddf4ce6: [
					() => n.e(802).then(n.t.bind(n, 3558, 19)),
					"@generated/docusaurus-plugin-content-docs/default/p/portfolio-projects-category-writing-projects-cd2.json",
					3558,
				],
			};
			var l = n(4848);
			...
			function d(e, t) {
				if ("*" === e)
					return o()({
						loading: s,
						loader: () => n.e(42).then(n.bind(n, 3042)),
			...
			const p = [
				{
					...
					component: d("/portfolio/about", "7b8"),
					exact: !0,
				},
				{
					path: "/portfolio/markdown-page",
					component: d("/portfolio/markdown-page", "f1a"),
					exact: !0,
				},
				{
					path: "/portfolio/projects",
					component: d("/portfolio/projects", "3c5"),
					routes: [
						{
							path: "/portfolio/projects",
							component: d("/portfolio/projects", "b3b"),
							routes: [
								{
									path: "/portfolio/projects",
									component: d("/portfolio/projects", "ee6"),
									routes: [
										{
											path: "/portfolio/projects/api-reference",
											component: d("/portfolio/projects/api-reference", "357"),
											exact: !0,
											sidebar: "tutorialSidebar",
										},
										{
											path: "/portfolio/projects/category/writing-projects",
											component: d(
												"/portfolio/projects/category/writing-projects",
												"3dc"
											),
											exact: !0,
											sidebar: "tutorialSidebar",
										...
										{
											path: "/portfolio/projects/concept-explainer",
											component: d(
												"/portfolio/projects/concept-explainer",
												"d86"
											),
											exact: !0,
											sidebar: "tutorialSidebar",
										...
										{
											path: "/portfolio/projects/method-terminology",
											component: d(
												"/portfolio/projects/method-terminology",
												"4e3"
											),
											exact: !0,
											sidebar: "tutorialSidebar",
										...
										{
											path: "/portfolio/projects/sdk-documentation",
											component: d(
												"/portfolio/projects/sdk-documentation",
												"4da"
											),
											exact: !0,
											sidebar: "tutorialSidebar",
										...
										{
											path: "/portfolio/projects/user-guide",
											component: d("/portfolio/projects/user-guide", "3d5"),
											exact: !0,
											sidebar: "tutorialSidebar",
										},
										{
											path: "/portfolio/projects/ux-writing",
											component: d("/portfolio/projects/ux-writing", "fca"),
											exact: !0,
											sidebar: "tutorialSidebar",
										},
									],
				...
				{ path: "/portfolio/", component: d("/portfolio/", "c34"), exact: !0 },
				{ path: "*", component: d("*") },
			];
		},
		9030: (e, t, n) => {
